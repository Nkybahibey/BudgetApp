...
def create_spend_chart(categories):
     ...
     while any(cat_names):
            ...
            for name in cat_names:
                  ...
                  s += "  \n"
       # Need to add strip to remove the newline character for last line and then add back the spaces. if anyone has a better solution, let me :)
                  s = s.strip() + ' '   
     ...
     business = Category("business")
      ...
      # entertainment.withdral(125, "black widow")
